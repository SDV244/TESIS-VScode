<<<<<<< HEAD:SCRIPTS/Data_Augmentation_Time_Mask.py
#%%
import pandas as pd
import numpy as np
...
#%%
# Read the dataframe
df = pd.read_csv('../SCRIPTS/TDL/PHYCUV/DATASET/Datos_70_Entrenamiento_para_augTRAIN-NO USAR-NO_TIENE_AUG.csv')
import pandas as pd
import numpy as np
import matplotlib.pyplot as plt
import os
...
aug_dir = '../SCRIPTS/TDL/PHYCUV/AUG_TEST/'
...
# %%
>>>>>>> parent of 7edc0fe0 (new data testing):SCRIPTS/Data_Augmentation.py
